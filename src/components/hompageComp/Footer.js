        ...
        <div class="footer-29 py-5">
            <div class="container py-lg-4">
                <div class="row align-items-center mb-3">
                    <h2 class="sign-left col-lg-7"> Join our community by using our services and grow your carrier </h2>
                ...
                <div class="row footer-top-29 mt-md-5 mt-4">
                    <div class="col-lg-4 col-md-6 footer-list-29 footer-1 pe-lg-5">
                        ...
                        <div class="footer-listw3-grids">
                            <p class="pe-lg-4">We empower students by providing a platform to buy, sell, and earn through educational products, freelancing, and mentorship, promoting financial independence and skill development.
                            ...
                            <div class="w3pt-call-box mt-4">
                                <div class="w3pt-call-info">
                                    ...
                                    <h5><a href="tel:#"><i class="fas fa-phone-alt me-1"></i> +91 xxxxxxx</a></h5>
                                    <h5><a href="tel:#"><i class="far fa-envelope me-1"></i> <a href="mailto:#" class="mail"> support@mail.com</a></a></h5>
                    ...
                    <div class="col-lg-2 col-md-6 footer-list-29 footer-3 mt-lg-0 mt-5">
                        ...
                        <div class="footer-listw3-grids">
                            <ul class="footer-listw3">
                                <li><a href="#lift">Freelancing</a></li>
                                <li><a href="#cardio">Digital marketplace</a></li>
                                <li><a href="#fit">Carierguidence and support</a></li>
                                <li><a href="#tips">Boost your skills</a></li>
                                <li><a href="#tips">Build your community</a></li>
                                <li><a href="#tips">Help other students</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="bottom-copies text-center">
                    <p class="copy-footer-29">© 2025 CampusCart. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
